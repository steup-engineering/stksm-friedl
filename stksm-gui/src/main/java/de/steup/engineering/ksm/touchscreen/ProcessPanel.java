...
public class ProcessPanel extends JPanel implements UpdatePanelInterface {
    ...
    public ProcessPanel(Window owner) {
        ...
        dp = new DevPanel(owner, "Fase unten", bevelUpperMotors, null, null, true, guiInData.getBevels()[1]);
        updatePanels.add(dp);
        bevelPanel.add(dp);
        ...
        dp = new DevPanel(owner, "Fase oben", bevelLowerMotors, null, null, true, guiInData.getBevels()[0]);
        updatePanels.add(dp);
        bevelPanel.add(dp);
